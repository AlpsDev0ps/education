...
Original file is located at
    https://colab.research.google.com/drive/1su6N6K5DD59EDEOkIq6ASUFFU4N8Si5B
"""
...
if __name__ == '__main__':
    ...
    # Нормализуем данные (опционально, но рекомендуется для лучшей сходимости)
    # В данном случае оставляем как есть, так как веса инициализируются нормализованными
